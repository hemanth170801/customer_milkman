      ...
      child: Stack(
        children: [
          Positioned(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  const CategHeaderLabel(headerLabel: 'Ghee',),
                  SizedBox(
                    ...
                    child: GridView.count(
                      ...
                      crossAxisSpacing: 15,
                      crossAxisCount: 2,
                      children: List.generate(ghee.length, (index) {
                        return SubcategModel(
                          mainCategName: 'Ghee',
                          subCategName: ghee[index],
                          assetName: 'images/company_logos/company$index.jpg',
                          subCategLabel: ghee[index],
                        );
                      }),
                    ),
                  )
          ...
          const Positioned(
            bottom: 0,
            right: 0,
            child: SliderBar(maincategName: 'Ghee',
            ),
          ),
        ],
      ),
